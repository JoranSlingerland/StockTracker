...
def calculate_sells_and_buys(stocks_held):
    ...
    for single_date, date_stocks_held in stocks_held['stocks_held'].items():
        ...
        #get buys
        date_stocks_held_buys = [d for d in date_stocks_held if d['transaction_type'] == 'Buy']
        ...
        for symbol_buys in symbols_buys:
            date_stock_held_buys = [d for d in date_stocks_held_buys if d['symbol'] == symbol_buys]
        ...
        #Get sells
        date_stocks_held_sells = [d for d in date_stocks_held if d['transaction_type'] == 'Sell']
        ...
        for symbol_sells in symbols_sells:
            date_stock_held_sells = [d for d in date_stocks_held_sells if d['symbol'] == symbol_sells]
